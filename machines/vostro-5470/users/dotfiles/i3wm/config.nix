...
bindsym $mod+Shift+e exec --no-startup-id ${builtins.toString scriptsPath}/power.sh
...
bindsym Mod1+F1 exec --no-startup-id ${builtins.toString scriptsPath}/dm-common.sh
